...
We utilize robust RPC infrastructure to process blockchain requests. Users have the option to provide their own custom RPC API keys (e.g., Alchemy, Infura, or custom endpoints). Any custom API keys you provide are strictly encrypted in our database at rest (AES-256-GCM). Only you can view and decrypt your keys.
